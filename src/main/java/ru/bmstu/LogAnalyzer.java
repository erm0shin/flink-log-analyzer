...
//        } catch (Exception e) {
//            System.err.println(
//                    "No port specified. Please run 'ru.bmstu.LogAnalyzer "
...
//        DataStream<String> text = env.socketTextStream(hostname, port, "\n");
        DataStream<String> text = env.readTextFile("file:///C:/Users/DErmoshin/text.txt");
//        text.print().setParallelism(1);
        text.writeAsText("file:///C:/Users/DErmoshin/out.txt", FileSystem.WriteMode.OVERWRITE).setParallelism(1);
...
//        windowCounts.print().setParallelism(1);
        windowCounts.writeAsText("file:///C:/Users/DErmoshin/out.txt", FileSystem.WriteMode.OVERWRITE).setParallelism(1);
